...
from paperqa_temp.settings import IndexSettings, get_settings
from paperqa_temp.types import DocDetails
from paperqa_temp.utils import ImpossibleParsingError, hexdigest
...
if TYPE_CHECKING:
    ...
    from paperqa_temp.settings import MaybeSettings, Settings
