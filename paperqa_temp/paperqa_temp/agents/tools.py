...
from paperqa_temp.llms import EmbeddingModel, LiteLLMModel
from paperqa_temp.settings import Settings
from paperqa_temp.types import DocDetails, Embeddable, PQASession
...
# - embedding_model: {self.embedding_model}
# - partitioning_fn: {self.partitioning_fn}
# - callbacks: {self.settings.agent.callbacks.get(f"{self.TOOL_FN_NAME}_aget_query")}
# """)
