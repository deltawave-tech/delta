...
from paperqa_temp.llms import EmbeddingModel, LiteLLMModel, embedding_model_factory
from paperqa_temp.prompts import (
...
from paperqa_temp.utils import hexdigest, pqa_directory
from paperqa_temp.version import __version__
...
class AnswerSettings(BaseModel):
    ...
    skip_answer_generation: bool = Field(
        default=True, description="Whether to summarization"
    )
...
class PromptSettings(BaseModel):
    ...
    def check_post(cls, v: str | None) -> str | None:
        if v is not None:
            ...
            from paperqa_temp.types import PQASession
...
class AgentSettings(BaseModel):
    ...
    skip_answer_generation: bool = Field(
        default=True,
        description="If True, only retrieve relevant chunks without generating final answer text."
    )

    agent_llm: str = Field(
        default="claude-3-7-sonnet-20250219",#gpt-4o-2024-08-06",
