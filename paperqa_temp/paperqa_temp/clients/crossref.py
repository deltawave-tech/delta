...
from paperqa_temp.types import CITATION_FALLBACK_DATA, DocDetails
from paperqa_temp.utils import BIBTEX_MAPPING as CROSSREF_CONTENT_TYPE_TO_BIBTEX_MAPPING
